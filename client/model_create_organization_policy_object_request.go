...
type _CreateOrganizationPolicyObjectRequest CreateOrganizationPolicyObjectRequest
...
func (o *CreateOrganizationPolicyObjectRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationPolicyObjectRequest := _CreateOrganizationPolicyObjectRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationPolicyObjectRequest)

	if err != nil {
		return err
	}

	*o = CreateOrganizationPolicyObjectRequest(varCreateOrganizationPolicyObjectRequest)
