...
func (r SsidsAPICreateNetworkWirelessSsidIdentityPskRequest) Execute() (*GetNetworkWirelessSsidIdentityPsks200ResponseInner, *http.Response, error) {
...
func (a *SsidsAPIService) CreateNetworkWirelessSsidIdentityPskExecute(r SsidsAPICreateNetworkWirelessSsidIdentityPskRequest) (*GetNetworkWirelessSsidIdentityPsks200ResponseInner, *http.Response, error) {
	var (
...
func (r SsidsAPIGetNetworkWirelessSsidBonjourForwardingRequest) Execute() (*GetNetworkWirelessSsidBonjourForwarding200Response, *http.Response, error) {
...
func (a *SsidsAPIService) GetNetworkWirelessSsidBonjourForwardingExecute(r SsidsAPIGetNetworkWirelessSsidBonjourForwardingRequest) (*GetNetworkWirelessSsidBonjourForwarding200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
...
func (a *SsidsAPIService) GetNetworkWirelessSsidFirewallL3FirewallRulesExecute(r SsidsAPIGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIGetNetworkWirelessSsidFirewallL7FirewallRulesRequest) Execute() (*GetNetworkWirelessSsidFirewallL7FirewallRules200Response, *http.Response, error) {
...
func (a *SsidsAPIService) GetNetworkWirelessSsidFirewallL7FirewallRulesExecute(r SsidsAPIGetNetworkWirelessSsidFirewallL7FirewallRulesRequest) (*GetNetworkWirelessSsidFirewallL7FirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIGetNetworkWirelessSsidSchedulesRequest) Execute() (*GetNetworkWirelessSsidSchedules200Response, *http.Response, error) {
...
func (a *SsidsAPIService) GetNetworkWirelessSsidSchedulesExecute(r SsidsAPIGetNetworkWirelessSsidSchedulesRequest) (*GetNetworkWirelessSsidSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIGetNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*GetNetworkWirelessSsidTrafficShapingRules200Response, *http.Response, error) {
...
func (a *SsidsAPIService) GetNetworkWirelessSsidTrafficShapingRulesExecute(r SsidsAPIGetNetworkWirelessSsidTrafficShapingRulesRequest) (*GetNetworkWirelessSsidTrafficShapingRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest) NetworkTag(networkTag string) SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest {
	r.networkTag = &networkTag
	return r
}

// Match result to an exact device tag
func (r SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest) DeviceTag(deviceTag string) SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest {
	r.deviceTag = &deviceTag
	return r
}

// Match result to an exact network id
func (r SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest) NetworkId(networkId string) SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest {
	r.networkId = &networkId
	return r
}

// Set number of desired results to return. Default is 10.
func (r SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest) Quantity(quantity int32) SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest {
	r.quantity = &quantity
	return r
}

// Filter results by ssid name
func (r SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest) SsidName(ssidName string) SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest {
	r.ssidName = &ssidName
	return r
}

// Filter results by usage uplink
func (r SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest) UsageUplink(usageUplink string) SsidsAPIGetOrganizationSummaryTopSsidsByUsageRequest {
...
type SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest struct {
	ctx context.Context
	ApiService *SsidsAPIService
	organizationId string
	networkIds *[]string
...
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) NetworkIds(networkIds []string) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.networkIds = &networkIds
	return r
}

// A list of serial numbers. The returned devices will be filtered to only include these serials.
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) Serials(serials []string) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.serials = &serials
	return r
}

// A list of BSSIDs. The returned devices will be filtered to only include these BSSIDs.
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) Bssids(bssids []string) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.bssids = &bssids
	return r
}

// If true, the returned devices will not include disabled SSIDs. (default: true)
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) HideDisabled(hideDisabled bool) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.hideDisabled = &hideDisabled
	return r
}

// The number of entries per page returned. Acceptable range is 3 - 500. Default is 100.
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) PerPage(perPage int32) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) StartingAfter(startingAfter string) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) EndingBefore(endingBefore string) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	r.endingBefore = &endingBefore
	return r
}

func (r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) Execute() (*GetOrganizationWirelessSsidsStatusesByDevice200Response, *http.Response, error) {
...
List status information of all BSSIDs in your organization
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest
*/
func (a *SsidsAPIService) GetOrganizationWirelessSsidsStatusesByDevice(ctx context.Context, organizationId string) SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest {
	return SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
func (a *SsidsAPIService) GetOrganizationWirelessSsidsStatusesByDeviceExecute(r SsidsAPIGetOrganizationWirelessSsidsStatusesByDeviceRequest) (*GetOrganizationWirelessSsidsStatusesByDevice200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SsidsAPIService.GetOrganizationWirelessSsidsStatusesByDevice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r SsidsAPIUpdateNetworkWirelessSsidBonjourForwardingRequest) Execute() (*GetNetworkWirelessSsidBonjourForwarding200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidBonjourForwarding200Response
func (a *SsidsAPIService) UpdateNetworkWirelessSsidBonjourForwardingExecute(r SsidsAPIUpdateNetworkWirelessSsidBonjourForwardingRequest) (*GetNetworkWirelessSsidBonjourForwarding200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidFirewallL3FirewallRules200Response
func (a *SsidsAPIService) UpdateNetworkWirelessSsidFirewallL3FirewallRulesExecute(r SsidsAPIUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIUpdateNetworkWirelessSsidFirewallL7FirewallRulesRequest) Execute() (*GetNetworkWirelessSsidFirewallL7FirewallRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidFirewallL7FirewallRules200Response
func (a *SsidsAPIService) UpdateNetworkWirelessSsidFirewallL7FirewallRulesExecute(r SsidsAPIUpdateNetworkWirelessSsidFirewallL7FirewallRulesRequest) (*GetNetworkWirelessSsidFirewallL7FirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIUpdateNetworkWirelessSsidIdentityPskRequest) Execute() (*GetNetworkWirelessSsidIdentityPsks200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidIdentityPsks200ResponseInner
func (a *SsidsAPIService) UpdateNetworkWirelessSsidIdentityPskExecute(r SsidsAPIUpdateNetworkWirelessSsidIdentityPskRequest) (*GetNetworkWirelessSsidIdentityPsks200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIUpdateNetworkWirelessSsidSchedulesRequest) Execute() (*GetNetworkWirelessSsidSchedules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidSchedules200Response
func (a *SsidsAPIService) UpdateNetworkWirelessSsidSchedulesExecute(r SsidsAPIUpdateNetworkWirelessSsidSchedulesRequest) (*GetNetworkWirelessSsidSchedules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SsidsAPIUpdateNetworkWirelessSsidTrafficShapingRulesRequest) Execute() (*GetNetworkWirelessSsidTrafficShapingRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidTrafficShapingRules200Response
func (a *SsidsAPIService) UpdateNetworkWirelessSsidTrafficShapingRulesExecute(r SsidsAPIUpdateNetworkWirelessSsidTrafficShapingRulesRequest) (*GetNetworkWirelessSsidTrafficShapingRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
