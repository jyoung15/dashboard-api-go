...
func (r OnboardingAPIGetOrganizationInventoryOnboardingCloudMonitoringNetworksRequest) Search(search string) OnboardingAPIGetOrganizationInventoryOnboardingCloudMonitoringNetworksRequest {
	r.search = &search
	return r
}
