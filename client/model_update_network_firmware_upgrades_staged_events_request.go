...
type _UpdateNetworkFirmwareUpgradesStagedEventsRequest UpdateNetworkFirmwareUpgradesStagedEventsRequest
...
func (o *UpdateNetworkFirmwareUpgradesStagedEventsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkFirmwareUpgradesStagedEventsRequest := _UpdateNetworkFirmwareUpgradesStagedEventsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkFirmwareUpgradesStagedEventsRequest)

	if err != nil {
		return err
	}

	*o = UpdateNetworkFirmwareUpgradesStagedEventsRequest(varUpdateNetworkFirmwareUpgradesStagedEventsRequest)
