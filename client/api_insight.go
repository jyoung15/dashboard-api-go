...
func (r InsightAPICreateOrganizationInsightMonitoredMediaServerRequest) Execute() (*GetOrganizationInsightMonitoredMediaServers200ResponseInner, *http.Response, error) {
...
func (a *InsightAPIService) CreateOrganizationInsightMonitoredMediaServerExecute(r InsightAPICreateOrganizationInsightMonitoredMediaServerRequest) (*GetOrganizationInsightMonitoredMediaServers200ResponseInner, *http.Response, error) {
	var (
...
func (r InsightAPIGetOrganizationInsightMonitoredMediaServerRequest) Execute() (*GetOrganizationInsightMonitoredMediaServers200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return GetOrganizationInsightMonitoredMediaServers200ResponseInner
func (a *InsightAPIService) GetOrganizationInsightMonitoredMediaServerExecute(r InsightAPIGetOrganizationInsightMonitoredMediaServerRequest) (*GetOrganizationInsightMonitoredMediaServers200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InsightAPIUpdateOrganizationInsightMonitoredMediaServerRequest) Execute() (*GetOrganizationInsightMonitoredMediaServers200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return GetOrganizationInsightMonitoredMediaServers200ResponseInner
func (a *InsightAPIService) UpdateOrganizationInsightMonitoredMediaServerExecute(r InsightAPIUpdateOrganizationInsightMonitoredMediaServerRequest) (*GetOrganizationInsightMonitoredMediaServers200ResponseInner, *http.Response, error) {
	var (
