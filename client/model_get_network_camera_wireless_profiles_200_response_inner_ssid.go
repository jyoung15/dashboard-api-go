...
// checks if the GetNetworkCameraWirelessProfiles200ResponseInnerSsid type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkCameraWirelessProfiles200ResponseInnerSsid{}

// GetNetworkCameraWirelessProfiles200ResponseInnerSsid The details of the SSID config.
type GetNetworkCameraWirelessProfiles200ResponseInnerSsid struct {
	// The name of the SSID.
	Name *string `json:"name,omitempty"`
	// The auth mode of the SSID. It can be set to ('psk', '8021x-radius').
	AuthMode *string `json:"authMode,omitempty"`
	// The encryption mode of the SSID.
	EncryptionMode *string `json:"encryptionMode,omitempty"`
	// The pre-shared key of the SSID, if mode is PSK
...
func NewGetNetworkCameraWirelessProfiles200ResponseInnerSsid() *GetNetworkCameraWirelessProfiles200ResponseInnerSsid {
	this := GetNetworkCameraWirelessProfiles200ResponseInnerSsid{}
	return &this
}
...
func (o GetNetworkCameraWirelessProfiles200ResponseInnerSsid) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkCameraWirelessProfiles200ResponseInnerSsid) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid struct {
	value *GetNetworkCameraWirelessProfiles200ResponseInnerSsid
	isSet bool
}

func (v NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid) Get() *GetNetworkCameraWirelessProfiles200ResponseInnerSsid {
	return v.value
}

func (v *NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid) Set(val *GetNetworkCameraWirelessProfiles200ResponseInnerSsid) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid(val *GetNetworkCameraWirelessProfiles200ResponseInnerSsid) *NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid {
	return &NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid{value: val, isSet: true}
}

func (v NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkCameraWirelessProfiles200ResponseInnerSsid) UnmarshalJSON(src []byte) error {
	v.isSet = true
