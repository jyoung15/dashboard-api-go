...
func (r ConfigurationChangesAPIGetOrganizationConfigurationChangesRequest) Execute() ([]GetOrganizationConfigurationChanges200ResponseInner, *http.Response, error) {
...
func (a *ConfigurationChangesAPIService) GetOrganizationConfigurationChangesExecute(r ConfigurationChangesAPIGetOrganizationConfigurationChangesRequest) ([]GetOrganizationConfigurationChanges200ResponseInner, *http.Response, error) {
	var (
