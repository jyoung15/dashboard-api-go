...
// checks if the UpdateNetworkClientSplashAuthorizationStatusRequestSsids12 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkClientSplashAuthorizationStatusRequestSsids12{}
...
func (o UpdateNetworkClientSplashAuthorizationStatusRequestSsids12) ToMap() (map[string]interface{}, error) {
