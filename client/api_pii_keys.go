...
func (r PiiKeysAPIGetNetworkPiiPiiKeysRequest) Execute() (*map[string]GetNetworkPiiPiiKeys200ResponseValue, *http.Response, error) {
...
func (a *PiiKeysAPIService) GetNetworkPiiPiiKeysExecute(r PiiKeysAPIGetNetworkPiiPiiKeysRequest) (*map[string]GetNetworkPiiPiiKeys200ResponseValue, *http.Response, error) {
	var (
