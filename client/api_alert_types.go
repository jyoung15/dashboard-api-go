...
func (r AlertTypesAPIGetOrganizationWebhooksAlertTypesRequest) Execute() (*GetOrganizationWebhooksAlertTypes200Response, *http.Response, error) {
...
func (a *AlertTypesAPIService) GetOrganizationWebhooksAlertTypesExecute(r AlertTypesAPIGetOrganizationWebhooksAlertTypesRequest) (*GetOrganizationWebhooksAlertTypes200Response, *http.Response, error) {
	var (
