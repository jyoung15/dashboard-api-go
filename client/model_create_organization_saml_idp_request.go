...
type _CreateOrganizationSamlIdpRequest CreateOrganizationSamlIdpRequest
...
func (o *CreateOrganizationSamlIdpRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationSamlIdpRequest := _CreateOrganizationSamlIdpRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationSamlIdpRequest)

	if err != nil {
		return err
	}

	*o = CreateOrganizationSamlIdpRequest(varCreateOrganizationSamlIdpRequest)
