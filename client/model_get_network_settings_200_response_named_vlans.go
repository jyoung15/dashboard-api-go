...
type _GetNetworkSettings200ResponseNamedVlans GetNetworkSettings200ResponseNamedVlans
...
func (o *GetNetworkSettings200ResponseNamedVlans) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNetworkSettings200ResponseNamedVlans := _GetNetworkSettings200ResponseNamedVlans{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNetworkSettings200ResponseNamedVlans)

	if err != nil {
		return err
	}

	*o = GetNetworkSettings200ResponseNamedVlans(varGetNetworkSettings200ResponseNamedVlans)
