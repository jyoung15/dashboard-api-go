...
// checks if the GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13{}

// GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 Settings for SSID 13
type GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 struct {
	// Name of SSID
...
// NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 instantiates a new GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 object
...
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13{}
	return &this
}

// NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13WithDefaults instantiates a new GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 object
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 struct {
	value *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) Get() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) Set(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13 {
	return &NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings13) UnmarshalJSON(src []byte) error {
	v.isSet = true
