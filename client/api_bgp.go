...
func (r BgpAPIGetNetworkApplianceVpnBgpRequest) Execute() (*GetNetworkApplianceVpnBgp200Response, *http.Response, error) {
...
func (a *BgpAPIService) GetNetworkApplianceVpnBgpExecute(r BgpAPIGetNetworkApplianceVpnBgpRequest) (*GetNetworkApplianceVpnBgp200Response, *http.Response, error) {
	var (
...
func (r BgpAPIUpdateNetworkApplianceVpnBgpRequest) Execute() (*GetNetworkApplianceVpnBgp200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkApplianceVpnBgp200Response
func (a *BgpAPIService) UpdateNetworkApplianceVpnBgpExecute(r BgpAPIUpdateNetworkApplianceVpnBgpRequest) (*GetNetworkApplianceVpnBgp200Response, *http.Response, error) {
	var (
