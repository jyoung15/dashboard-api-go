...
type _BindNetworkRequest BindNetworkRequest
...
func (o *BindNetworkRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBindNetworkRequest := _BindNetworkRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBindNetworkRequest)

	if err != nil {
		return err
	}

	*o = BindNetworkRequest(varBindNetworkRequest)
