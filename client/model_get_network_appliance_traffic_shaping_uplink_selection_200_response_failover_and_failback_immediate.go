...
type _GetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate GetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate
...
func (o *GetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate) UnmarshalJSON(data []byte) (err error) {
	...
	varGetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate := _GetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate)

	if err != nil {
		return err
	}

	*o = GetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate(varGetNetworkApplianceTrafficShapingUplinkSelection200ResponseFailoverAndFailbackImmediate)
