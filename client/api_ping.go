...
func (r PingAPIGetDeviceLiveToolsPingRequest) Execute() (*DevicesSerialLiveToolsPingPostRequestMessage, *http.Response, error) {
...
func (a *PingAPIService) GetDeviceLiveToolsPingExecute(r PingAPIGetDeviceLiveToolsPingRequest) (*DevicesSerialLiveToolsPingPostRequestMessage, *http.Response, error) {
	var (
