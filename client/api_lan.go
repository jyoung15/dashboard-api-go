...
func (r LanAPIGetDeviceCellularGatewayLanRequest) Execute() (*GetDeviceCellularGatewayLan200Response, *http.Response, error) {
...
func (a *LanAPIService) GetDeviceCellularGatewayLanExecute(r LanAPIGetDeviceCellularGatewayLanRequest) (*GetDeviceCellularGatewayLan200Response, *http.Response, error) {
	var (
...
func (r LanAPIUpdateDeviceCellularGatewayLanRequest) Execute() (*GetDeviceCellularGatewayLan200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetDeviceCellularGatewayLan200Response
func (a *LanAPIService) UpdateDeviceCellularGatewayLanExecute(r LanAPIUpdateDeviceCellularGatewayLanRequest) (*GetDeviceCellularGatewayLan200Response, *http.Response, error) {
	var (
