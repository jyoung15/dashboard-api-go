...
type UpdateNetworkApplianceVlanRequest struct {
	...
	ReservedIpRanges []UpdateNetworkApplianceVlanRequestReservedIpRangesInner `json:"reservedIpRanges,omitempty"`
...
func (o *UpdateNetworkApplianceVlanRequest) GetReservedIpRanges() []UpdateNetworkApplianceVlanRequestReservedIpRangesInner {
	if o == nil || IsNil(o.ReservedIpRanges) {
		var ret []UpdateNetworkApplianceVlanRequestReservedIpRangesInner
		return ret
	}
...
// SetReservedIpRanges gets a reference to the given []UpdateNetworkApplianceVlanRequestReservedIpRangesInner and assigns it to the ReservedIpRanges field.
