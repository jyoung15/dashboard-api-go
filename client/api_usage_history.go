...
func (r UsageHistoryAPIGetNetworkClientUsageHistoryRequest) Execute() ([]GetNetworkClientUsageHistory200ResponseInner, *http.Response, error) {
...
func (a *UsageHistoryAPIService) GetNetworkClientUsageHistoryExecute(r UsageHistoryAPIGetNetworkClientUsageHistoryRequest) ([]GetNetworkClientUsageHistory200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
