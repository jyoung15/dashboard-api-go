...
type _RemoveNetworkSwitchStackRequest RemoveNetworkSwitchStackRequest
...
func (o *RemoveNetworkSwitchStackRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRemoveNetworkSwitchStackRequest := _RemoveNetworkSwitchStackRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRemoveNetworkSwitchStackRequest)

	if err != nil {
		return err
	}

	*o = RemoveNetworkSwitchStackRequest(varRemoveNetworkSwitchStackRequest)
