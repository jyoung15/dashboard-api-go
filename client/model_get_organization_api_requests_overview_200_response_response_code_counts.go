...
func NewGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts() *GetOrganizationApiRequestsOverview200ResponseResponseCodeCounts {
	this := GetOrganizationApiRequestsOverview200ResponseResponseCodeCounts{}
	return &this
}
...
type NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts struct {
	value *GetOrganizationApiRequestsOverview200ResponseResponseCodeCounts
	isSet bool
}

func (v NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) Get() *GetOrganizationApiRequestsOverview200ResponseResponseCodeCounts {
	return v.value
}

func (v *NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) Set(val *GetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts(val *GetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) *NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts {
	return &NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts{value: val, isSet: true}
}

func (v NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationApiRequestsOverview200ResponseResponseCodeCounts) UnmarshalJSON(src []byte) error {
	v.isSet = true
