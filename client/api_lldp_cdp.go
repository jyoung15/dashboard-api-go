...
func (r LldpCdpAPIGetDeviceLldpCdpRequest) Execute() (*GetDeviceLldpCdp200Response, *http.Response, error) {
...
func (a *LldpCdpAPIService) GetDeviceLldpCdpExecute(r LldpCdpAPIGetDeviceLldpCdpRequest) (*GetDeviceLldpCdp200Response, *http.Response, error) {
	var (
