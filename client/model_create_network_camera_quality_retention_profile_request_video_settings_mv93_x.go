...
type _CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X
...
func (o *CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X := _CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X)

	if err != nil {
		return err
	}

	*o = CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X(varCreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV93X)
