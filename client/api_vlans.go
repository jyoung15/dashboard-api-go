...
func (r VlansAPIGetNetworkApplianceVlansSettingsRequest) Execute() (*GetNetworkApplianceVlansSettings200Response, *http.Response, error) {
...
func (a *VlansAPIService) GetNetworkApplianceVlansSettingsExecute(r VlansAPIGetNetworkApplianceVlansSettingsRequest) (*GetNetworkApplianceVlansSettings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VlansAPIUpdateNetworkApplianceVlansSettingsRequest) Execute() (*GetNetworkApplianceVlansSettings200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkApplianceVlansSettings200Response
func (a *VlansAPIService) UpdateNetworkApplianceVlansSettingsExecute(r VlansAPIUpdateNetworkApplianceVlansSettingsRequest) (*GetNetworkApplianceVlansSettings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
