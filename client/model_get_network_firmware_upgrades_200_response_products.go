...
type GetNetworkFirmwareUpgrades200ResponseProducts struct {
	...
	WirelessController *GetNetworkFirmwareUpgrades200ResponseProductsWireless `json:"wirelessController,omitempty"`
	SecureConnect *GetNetworkFirmwareUpgrades200ResponseProductsWireless `json:"secureConnect,omitempty"`
}
...
// SetWirelessController gets a reference to the given GetNetworkFirmwareUpgrades200ResponseProductsWireless and assigns it to the WirelessController field.
...
// SetSecureConnect gets a reference to the given GetNetworkFirmwareUpgrades200ResponseProductsWireless and assigns it to the SecureConnect field.
