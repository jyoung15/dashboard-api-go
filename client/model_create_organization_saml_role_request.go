...
type _CreateOrganizationSamlRoleRequest CreateOrganizationSamlRoleRequest
...
func (o *CreateOrganizationSamlRoleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationSamlRoleRequest := _CreateOrganizationSamlRoleRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationSamlRoleRequest)

	if err != nil {
		return err
	}

	*o = CreateOrganizationSamlRoleRequest(varCreateOrganizationSamlRoleRequest)
