...
type GetDevice200Response struct {
	...
	BeaconIdParams *GetDevice200ResponseBeaconIdParams `json:"beaconIdParams,omitempty"`
}
...
func (o *GetDevice200Response) GetBeaconIdParams() GetDevice200ResponseBeaconIdParams {
	if o == nil || IsNil(o.BeaconIdParams) {
		var ret GetDevice200ResponseBeaconIdParams
		return ret
	}
...
// SetBeaconIdParams gets a reference to the given GetDevice200ResponseBeaconIdParams and assigns it to the BeaconIdParams field.
