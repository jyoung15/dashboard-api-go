...
// checks if the GetDeviceCameraAnalyticsOverview200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceCameraAnalyticsOverview200ResponseInner{}

// GetDeviceCameraAnalyticsOverview200ResponseInner struct for GetDeviceCameraAnalyticsOverview200ResponseInner
type GetDeviceCameraAnalyticsOverview200ResponseInner struct {
	// The start time
...
func NewGetDeviceCameraAnalyticsOverview200ResponseInner() *GetDeviceCameraAnalyticsOverview200ResponseInner {
	this := GetDeviceCameraAnalyticsOverview200ResponseInner{}
	return &this
}
...
func (o GetDeviceCameraAnalyticsOverview200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceCameraAnalyticsOverview200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeviceCameraAnalyticsOverview200ResponseInner struct {
	value *GetDeviceCameraAnalyticsOverview200ResponseInner
	isSet bool
}

func (v NullableGetDeviceCameraAnalyticsOverview200ResponseInner) Get() *GetDeviceCameraAnalyticsOverview200ResponseInner {
	return v.value
}

func (v *NullableGetDeviceCameraAnalyticsOverview200ResponseInner) Set(val *GetDeviceCameraAnalyticsOverview200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceCameraAnalyticsOverview200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceCameraAnalyticsOverview200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceCameraAnalyticsOverview200ResponseInner(val *GetDeviceCameraAnalyticsOverview200ResponseInner) *NullableGetDeviceCameraAnalyticsOverview200ResponseInner {
	return &NullableGetDeviceCameraAnalyticsOverview200ResponseInner{value: val, isSet: true}
}

func (v NullableGetDeviceCameraAnalyticsOverview200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceCameraAnalyticsOverview200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
