...
func (r RequestsAPICreateNetworkPiiRequestRequest) Execute() (*GetNetworkPiiRequests200ResponseInner, *http.Response, error) {
...
func (a *RequestsAPIService) CreateNetworkPiiRequestExecute(r RequestsAPICreateNetworkPiiRequestRequest) (*GetNetworkPiiRequests200ResponseInner, *http.Response, error) {
	var (
...
func (r RequestsAPIGetNetworkPiiRequestRequest) Execute() (*GetNetworkPiiRequests200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkPiiRequests200ResponseInner
func (a *RequestsAPIService) GetNetworkPiiRequestExecute(r RequestsAPIGetNetworkPiiRequestRequest) (*GetNetworkPiiRequests200ResponseInner, *http.Response, error) {
	var (
...
func (r RequestsAPIGetNetworkPiiRequestsRequest) Execute() ([]GetNetworkPiiRequests200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return []GetNetworkPiiRequests200ResponseInner
func (a *RequestsAPIService) GetNetworkPiiRequestsExecute(r RequestsAPIGetNetworkPiiRequestsRequest) ([]GetNetworkPiiRequests200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
