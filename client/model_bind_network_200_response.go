...
// checks if the BindNetwork200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BindNetwork200Response{}

// BindNetwork200Response struct for BindNetwork200Response
type BindNetwork200Response struct {
	// Network ID
...
// SetConfigTemplateId gets a reference to the given string and assigns it to the ConfigTemplateId field.
func (o *BindNetwork200Response) SetConfigTemplateId(v string) {
	o.ConfigTemplateId = &v
}

func (o BindNetwork200Response) MarshalJSON() ([]byte, error) {
...
func (o BindNetwork200Response) ToMap() (map[string]interface{}, error) {
...
type NullableBindNetwork200Response struct {
	value *BindNetwork200Response
	isSet bool
}

func (v NullableBindNetwork200Response) Get() *BindNetwork200Response {
	return v.value
}

func (v *NullableBindNetwork200Response) Set(val *BindNetwork200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableBindNetwork200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableBindNetwork200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBindNetwork200Response(val *BindNetwork200Response) *NullableBindNetwork200Response {
	return &NullableBindNetwork200Response{value: val, isSet: true}
}

func (v NullableBindNetwork200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBindNetwork200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
