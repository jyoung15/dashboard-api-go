...
type _UpdateNetworkSwitchQosRulesOrderRequest UpdateNetworkSwitchQosRulesOrderRequest
...
func (o *UpdateNetworkSwitchQosRulesOrderRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkSwitchQosRulesOrderRequest := _UpdateNetworkSwitchQosRulesOrderRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkSwitchQosRulesOrderRequest)

	if err != nil {
		return err
	}

	*o = UpdateNetworkSwitchQosRulesOrderRequest(varUpdateNetworkSwitchQosRulesOrderRequest)
