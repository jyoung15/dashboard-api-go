...
func (r ActionBatchesAPIGetOrganizationActionBatchesRequest) Execute() ([]GetOrganizationActionBatches200ResponseInner, *http.Response, error) {
...
func (a *ActionBatchesAPIService) GetOrganizationActionBatchesExecute(r ActionBatchesAPIGetOrganizationActionBatchesRequest) ([]GetOrganizationActionBatches200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ActionBatchesAPIUpdateOrganizationActionBatchRequest) Execute() (*GetOrganizationActionBatches200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return GetOrganizationActionBatches200ResponseInner
func (a *ActionBatchesAPIService) UpdateOrganizationActionBatchExecute(r ActionBatchesAPIUpdateOrganizationActionBatchRequest) (*GetOrganizationActionBatches200ResponseInner, *http.Response, error) {
	var (
