...
// checks if the GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner{}

// GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner struct for GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner
type GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner struct {
	...
	Module *GetDeviceSwitchPorts200ResponseInnerModule `json:"module,omitempty"`
	Mirror *GetDeviceSwitchPorts200ResponseInnerMirror `json:"mirror,omitempty"`
	Dot3az *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInnerDot3az `json:"dot3az,omitempty"`
}
...
func NewGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner() *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner {
	this := GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner{}
	return &this
}
...
func (o *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) GetModule() GetDeviceSwitchPorts200ResponseInnerModule {
	if o == nil || IsNil(o.Module) {
		var ret GetDeviceSwitchPorts200ResponseInnerModule
		return ret
	}
	return *o.Module
}
...
// SetModule gets a reference to the given GetDeviceSwitchPorts200ResponseInnerModule and assigns it to the Module field.
...
func (o *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) GetMirror() GetDeviceSwitchPorts200ResponseInnerMirror {
	if o == nil || IsNil(o.Mirror) {
		var ret GetDeviceSwitchPorts200ResponseInnerMirror
		return ret
	}
	return *o.Mirror
}
...
// SetMirror gets a reference to the given GetDeviceSwitchPorts200ResponseInnerMirror and assigns it to the Mirror field.
...
func (o *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) GetDot3az() GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInnerDot3az {
	if o == nil || IsNil(o.Dot3az) {
		var ret GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInnerDot3az
		return ret
	}
	return *o.Dot3az
}
...
// SetDot3az gets a reference to the given GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInnerDot3az and assigns it to the Dot3az field.
...
func (o GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner struct {
	value *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner
	isSet bool
}

func (v NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) Get() *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner {
	return v.value
}

func (v *NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) Set(val *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner(val *GetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) *NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner {
	return &NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner{value: val, isSet: true}
}

func (v NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationConfigTemplateSwitchProfilePorts200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
