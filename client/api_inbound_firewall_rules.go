...
func (r InboundFirewallRulesAPIGetNetworkApplianceFirewallInboundFirewallRulesRequest) Execute() (*GetNetworkApplianceFirewallInboundFirewallRules200Response, *http.Response, error) {
...
func (a *InboundFirewallRulesAPIService) GetNetworkApplianceFirewallInboundFirewallRulesExecute(r InboundFirewallRulesAPIGetNetworkApplianceFirewallInboundFirewallRulesRequest) (*GetNetworkApplianceFirewallInboundFirewallRules200Response, *http.Response, error) {
	var (
...
func (r InboundFirewallRulesAPIUpdateNetworkApplianceFirewallInboundFirewallRulesRequest) Execute() (*GetNetworkApplianceFirewallInboundFirewallRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkApplianceFirewallInboundFirewallRules200Response
func (a *InboundFirewallRulesAPIService) UpdateNetworkApplianceFirewallInboundFirewallRulesExecute(r InboundFirewallRulesAPIUpdateNetworkApplianceFirewallInboundFirewallRulesRequest) (*GetNetworkApplianceFirewallInboundFirewallRules200Response, *http.Response, error) {
	var (
