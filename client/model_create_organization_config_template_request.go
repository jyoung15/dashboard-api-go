...
type _CreateOrganizationConfigTemplateRequest CreateOrganizationConfigTemplateRequest
...
func (o *CreateOrganizationConfigTemplateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationConfigTemplateRequest := _CreateOrganizationConfigTemplateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationConfigTemplateRequest)

	if err != nil {
		return err
	}

	*o = CreateOrganizationConfigTemplateRequest(varCreateOrganizationConfigTemplateRequest)
