...
type UpdateNetworkWirelessSsidRequest struct {
	...
	NamedVlans *UpdateNetworkWirelessSsidRequestNamedVlans `json:"namedVlans,omitempty"`
}
...
func (o *UpdateNetworkWirelessSsidRequest) GetNamedVlans() UpdateNetworkWirelessSsidRequestNamedVlans {
	if o == nil || IsNil(o.NamedVlans) {
		var ret UpdateNetworkWirelessSsidRequestNamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given UpdateNetworkWirelessSsidRequestNamedVlans and assigns it to the NamedVlans field.
