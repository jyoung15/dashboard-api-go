...
// checks if the GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic{}

// GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic The time bucket's best effort traffic latency history
type GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic struct {
	// The latency bucket for best effort traffic in 0.5 seconds
	Var05 *int32 `json:"0.5,omitempty"`
	// The latency bucket for best effort traffic in 1.0 seconds
	Var10 *int32 `json:"1.0,omitempty"`
	// The latency bucket for best effort traffic in 2.0 seconds
	Var20 *int32 `json:"2.0,omitempty"`
	// The latency bucket for best effort traffic in 4.0 seconds
	Var40 *int32 `json:"4.0,omitempty"`
	// The latency bucket for best effort traffic in 8.0 seconds
	Var80 *int32 `json:"8.0,omitempty"`
	// The latency bucket for best effort traffic in 16.0 seconds
	Var160 *int32 `json:"16.0,omitempty"`
	// The latency bucket for best effort traffic in 32.0 seconds
	Var320 *int32 `json:"32.0,omitempty"`
	// The latency bucket for best effort traffic in 64.0 seconds
	Var640 *int32 `json:"64.0,omitempty"`
	// The latency bucket for best effort traffic in 128.0 seconds
	Var1280 *int32 `json:"128.0,omitempty"`
	// The latency bucket for best effort traffic in 256.0 seconds
	Var2560 *int32 `json:"256.0,omitempty"`
	// The latency bucket for best effort traffic in 512.0 seconds
	Var5120 *int32 `json:"512.0,omitempty"`
	// The latency bucket for best effort traffic in 1024.0 seconds
	Var10240 *int32 `json:"1024.0,omitempty"`
	// The latency bucket for best effort traffic in 2048.0 seconds
...
func NewGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic() *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic {
	this := GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic{}
	return &this
}
...
func (o GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic struct {
	value *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic
	isSet bool
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) Get() *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic {
	return v.value
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) Set(val *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic(val *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic {
	return &NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBestEffortTraffic) UnmarshalJSON(src []byte) error {
	v.isSet = true
