...
// checks if the GetOrganizationDevicesAvailabilities200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationDevicesAvailabilities200ResponseInner{}

// GetOrganizationDevicesAvailabilities200ResponseInner struct for GetOrganizationDevicesAvailabilities200ResponseInner
type GetOrganizationDevicesAvailabilities200ResponseInner struct {
...
func NewGetOrganizationDevicesAvailabilities200ResponseInner() *GetOrganizationDevicesAvailabilities200ResponseInner {
	this := GetOrganizationDevicesAvailabilities200ResponseInner{}
	return &this
}
...
func (o GetOrganizationDevicesAvailabilities200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetOrganizationDevicesAvailabilities200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrganizationDevicesAvailabilities200ResponseInner struct {
	value *GetOrganizationDevicesAvailabilities200ResponseInner
	isSet bool
}

func (v NullableGetOrganizationDevicesAvailabilities200ResponseInner) Get() *GetOrganizationDevicesAvailabilities200ResponseInner {
	return v.value
}

func (v *NullableGetOrganizationDevicesAvailabilities200ResponseInner) Set(val *GetOrganizationDevicesAvailabilities200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationDevicesAvailabilities200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationDevicesAvailabilities200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationDevicesAvailabilities200ResponseInner(val *GetOrganizationDevicesAvailabilities200ResponseInner) *NullableGetOrganizationDevicesAvailabilities200ResponseInner {
	return &NullableGetOrganizationDevicesAvailabilities200ResponseInner{value: val, isSet: true}
}

func (v NullableGetOrganizationDevicesAvailabilities200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationDevicesAvailabilities200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
