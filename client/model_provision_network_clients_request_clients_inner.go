...
type _ProvisionNetworkClientsRequestClientsInner ProvisionNetworkClientsRequestClientsInner
...
func (o *ProvisionNetworkClientsRequestClientsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProvisionNetworkClientsRequestClientsInner := _ProvisionNetworkClientsRequestClientsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProvisionNetworkClientsRequestClientsInner)

	if err != nil {
		return err
	}

	*o = ProvisionNetworkClientsRequestClientsInner(varProvisionNetworkClientsRequestClientsInner)
