...
func (r PerformanceAPIGetDeviceAppliancePerformanceRequest) T0(t0 string) PerformanceAPIGetDeviceAppliancePerformanceRequest {
	r.t0 = &t0
	return r
}

// The end of the timespan for the data. t1 can be a maximum of 14 days after t0.
func (r PerformanceAPIGetDeviceAppliancePerformanceRequest) T1(t1 string) PerformanceAPIGetDeviceAppliancePerformanceRequest {
	r.t1 = &t1
	return r
}
...
func (r PerformanceAPIGetDeviceAppliancePerformanceRequest) Timespan(timespan float32) PerformanceAPIGetDeviceAppliancePerformanceRequest {
	r.timespan = &timespan
	return r
}
