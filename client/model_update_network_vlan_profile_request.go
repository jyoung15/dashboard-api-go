...
type _UpdateNetworkVlanProfileRequest UpdateNetworkVlanProfileRequest
...
func (o *UpdateNetworkVlanProfileRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkVlanProfileRequest := _UpdateNetworkVlanProfileRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkVlanProfileRequest)

	if err != nil {
		return err
	}

	*o = UpdateNetworkVlanProfileRequest(varUpdateNetworkVlanProfileRequest)
