...
type _ClaimIntoOrganizationInventoryRequestLicensesInner ClaimIntoOrganizationInventoryRequestLicensesInner
...
func (o *ClaimIntoOrganizationInventoryRequestLicensesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varClaimIntoOrganizationInventoryRequestLicensesInner := _ClaimIntoOrganizationInventoryRequestLicensesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClaimIntoOrganizationInventoryRequestLicensesInner)

	if err != nil {
		return err
	}

	*o = ClaimIntoOrganizationInventoryRequestLicensesInner(varClaimIntoOrganizationInventoryRequestLicensesInner)
