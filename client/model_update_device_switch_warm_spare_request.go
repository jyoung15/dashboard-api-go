...
type _UpdateDeviceSwitchWarmSpareRequest UpdateDeviceSwitchWarmSpareRequest
...
func (o *UpdateDeviceSwitchWarmSpareRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDeviceSwitchWarmSpareRequest := _UpdateDeviceSwitchWarmSpareRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDeviceSwitchWarmSpareRequest)

	if err != nil {
		return err
	}

	*o = UpdateDeviceSwitchWarmSpareRequest(varUpdateDeviceSwitchWarmSpareRequest)
