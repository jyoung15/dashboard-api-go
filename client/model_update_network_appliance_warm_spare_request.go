...
type _UpdateNetworkApplianceWarmSpareRequest UpdateNetworkApplianceWarmSpareRequest
...
func (o *UpdateNetworkApplianceWarmSpareRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkApplianceWarmSpareRequest := _UpdateNetworkApplianceWarmSpareRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkApplianceWarmSpareRequest)

	if err != nil {
		return err
	}

	*o = UpdateNetworkApplianceWarmSpareRequest(varUpdateNetworkApplianceWarmSpareRequest)
