...
func (r ClaimAPIVmxNetworkDevicesClaimRequest) Execute() (*VmxNetworkDevicesClaim200Response, *http.Response, error) {
...
func (a *ClaimAPIService) VmxNetworkDevicesClaimExecute(r ClaimAPIVmxNetworkDevicesClaimRequest) (*VmxNetworkDevicesClaim200Response, *http.Response, error) {
	var (
