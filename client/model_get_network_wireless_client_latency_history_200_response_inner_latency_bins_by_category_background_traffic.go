...
// checks if the GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic{}

// GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic The time bucket's background traffic latency history
type GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic struct {
...
func NewGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic() *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic {
	this := GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic{}
	return &this
}
...
func (o GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic struct {
	value *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic
	isSet bool
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) Get() *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic {
	return v.value
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) Set(val *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic(val *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic {
	return &NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryBackgroundTraffic) UnmarshalJSON(src []byte) error {
	v.isSet = true
