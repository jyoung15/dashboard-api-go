...
func (r SplashLoginAttemptsAPIGetNetworkSplashLoginAttemptsRequest) Execute() ([]GetNetworkSplashLoginAttempts200ResponseInner, *http.Response, error) {
...
func (a *SplashLoginAttemptsAPIService) GetNetworkSplashLoginAttemptsExecute(r SplashLoginAttemptsAPIGetNetworkSplashLoginAttemptsRequest) ([]GetNetworkSplashLoginAttempts200ResponseInner, *http.Response, error) {
	var (
