...
func (r ZonesAPIGetDeviceCameraAnalyticsZoneHistoryRequest) Execute() ([]GetDeviceCameraAnalyticsZoneHistory200ResponseInner, *http.Response, error) {
...
// Deprecated
func (a *ZonesAPIService) GetDeviceCameraAnalyticsZoneHistoryExecute(r ZonesAPIGetDeviceCameraAnalyticsZoneHistoryRequest) ([]GetDeviceCameraAnalyticsZoneHistory200ResponseInner, *http.Response, error) {
	var (
...
func (r ZonesAPIGetDeviceCameraAnalyticsZonesRequest) Execute() ([]GetDeviceCameraAnalyticsZones200ResponseInner, *http.Response, error) {
...
// Deprecated
func (a *ZonesAPIService) GetDeviceCameraAnalyticsZonesExecute(r ZonesAPIGetDeviceCameraAnalyticsZonesRequest) ([]GetDeviceCameraAnalyticsZones200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
