...
// checks if the GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion{}

// GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion ID of the upgrade's starting version
type GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion struct {
	// Firmware version ID
...
func NewGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion() *GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion {
	this := GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion{}
	return &this
}
...
func (o GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) MarshalJSON() ([]byte, error) {
...
func (o GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion struct {
	value *GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion
	isSet bool
}

func (v NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) Get() *GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion {
	return v.value
}

func (v *NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) Set(val *GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion(val *GetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) *NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion {
	return &NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion{value: val, isSet: true}
}

func (v NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationFirmwareUpgrades200ResponseInnerFromVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
