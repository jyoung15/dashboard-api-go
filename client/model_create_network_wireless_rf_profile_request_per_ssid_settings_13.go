...
// checks if the CreateNetworkWirelessRfProfileRequestPerSsidSettings13 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkWirelessRfProfileRequestPerSsidSettings13{}

// CreateNetworkWirelessRfProfileRequestPerSsidSettings13 Settings for SSID 13
type CreateNetworkWirelessRfProfileRequestPerSsidSettings13 struct {
...
func NewCreateNetworkWirelessRfProfileRequestPerSsidSettings13() *CreateNetworkWirelessRfProfileRequestPerSsidSettings13 {
	this := CreateNetworkWirelessRfProfileRequestPerSsidSettings13{}
	return &this
}
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings13) GetBands() CreateNetworkWirelessRfProfileRequestApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings13) GetBandsOk() (*CreateNetworkWirelessRfProfileRequestApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings13) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings13) SetBands(v CreateNetworkWirelessRfProfileRequestApBandSettingsBands) {
	o.Bands = &v
}
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings13) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings13) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13 struct {
	value *CreateNetworkWirelessRfProfileRequestPerSsidSettings13
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13) Get() *CreateNetworkWirelessRfProfileRequestPerSsidSettings13 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13) Set(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings13) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings13) *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13 {
	return &NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings13) UnmarshalJSON(src []byte) error {
	v.isSet = true
