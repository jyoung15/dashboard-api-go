...
type GetDeviceSwitchPorts200ResponseInner struct {
	...
	Dot3az *GetDeviceSwitchPorts200ResponseInnerDot3az `json:"dot3az,omitempty"`
}
...
func (o *GetDeviceSwitchPorts200ResponseInner) GetDot3az() GetDeviceSwitchPorts200ResponseInnerDot3az {
	if o == nil || IsNil(o.Dot3az) {
		var ret GetDeviceSwitchPorts200ResponseInnerDot3az
		return ret
	}
	return *o.Dot3az
}
...
// SetDot3az gets a reference to the given GetDeviceSwitchPorts200ResponseInnerDot3az and assigns it to the Dot3az field.
