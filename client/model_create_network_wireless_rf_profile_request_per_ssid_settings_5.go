...
// checks if the CreateNetworkWirelessRfProfileRequestPerSsidSettings5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkWirelessRfProfileRequestPerSsidSettings5{}

// CreateNetworkWirelessRfProfileRequestPerSsidSettings5 Settings for SSID 5
type CreateNetworkWirelessRfProfileRequestPerSsidSettings5 struct {
...
func NewCreateNetworkWirelessRfProfileRequestPerSsidSettings5() *CreateNetworkWirelessRfProfileRequestPerSsidSettings5 {
	this := CreateNetworkWirelessRfProfileRequestPerSsidSettings5{}
	return &this
}
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings5) GetBands() CreateNetworkWirelessRfProfileRequestApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings5) GetBandsOk() (*CreateNetworkWirelessRfProfileRequestApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings5) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings5) SetBands(v CreateNetworkWirelessRfProfileRequestApBandSettingsBands) {
	o.Bands = &v
}
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings5) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings5) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5 struct {
	value *CreateNetworkWirelessRfProfileRequestPerSsidSettings5
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5) Get() *CreateNetworkWirelessRfProfileRequestPerSsidSettings5 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5) Set(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings5) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings5) *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5 {
	return &NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings5) UnmarshalJSON(src []byte) error {
	v.isSet = true
