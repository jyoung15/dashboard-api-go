...
// checks if the GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6{}

// GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 Settings for SSID 6
type GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 struct {
	// Name of SSID
...
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6{}
	return &this
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) GetBands() GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) GetBandsOk() (*GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) SetBands(v GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands) {
	o.Bands = &v
}
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 struct {
	value *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) Get() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) Set(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6 {
	return &NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings6) UnmarshalJSON(src []byte) error {
	v.isSet = true
