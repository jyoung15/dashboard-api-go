...
type _ProvisionNetworkClientsRequest ProvisionNetworkClientsRequest
...
func (o *ProvisionNetworkClientsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varProvisionNetworkClientsRequest := _ProvisionNetworkClientsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProvisionNetworkClientsRequest)

	if err != nil {
		return err
	}

	*o = ProvisionNetworkClientsRequest(varProvisionNetworkClientsRequest)
