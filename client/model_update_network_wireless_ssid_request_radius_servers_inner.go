...
type _UpdateNetworkWirelessSsidRequestRadiusServersInner UpdateNetworkWirelessSsidRequestRadiusServersInner
...
func (o *UpdateNetworkWirelessSsidRequestRadiusServersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkWirelessSsidRequestRadiusServersInner := _UpdateNetworkWirelessSsidRequestRadiusServersInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkWirelessSsidRequestRadiusServersInner)

	if err != nil {
		return err
	}

	*o = UpdateNetworkWirelessSsidRequestRadiusServersInner(varUpdateNetworkWirelessSsidRequestRadiusServersInner)
