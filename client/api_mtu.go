...
func (r MtuAPIUpdateNetworkSwitchMtuRequest) Execute() (*GetNetworkSwitchMtu200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkSwitchMtu200Response
func (a *MtuAPIService) UpdateNetworkSwitchMtuExecute(r MtuAPIUpdateNetworkSwitchMtuRequest) (*GetNetworkSwitchMtu200Response, *http.Response, error) {
	var (
