...
func (r VideoAPIGetDeviceCameraVideoSettingsRequest) Execute() (*GetDeviceCameraVideoSettings200Response, *http.Response, error) {
...
func (a *VideoAPIService) GetDeviceCameraVideoSettingsExecute(r VideoAPIGetDeviceCameraVideoSettingsRequest) (*GetDeviceCameraVideoSettings200Response, *http.Response, error) {
	var (
...
func (r VideoAPIUpdateDeviceCameraVideoSettingsRequest) Execute() (*GetDeviceCameraVideoSettings200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetDeviceCameraVideoSettings200Response
func (a *VideoAPIService) UpdateDeviceCameraVideoSettingsExecute(r VideoAPIUpdateDeviceCameraVideoSettingsRequest) (*GetDeviceCameraVideoSettings200Response, *http.Response, error) {
	var (
