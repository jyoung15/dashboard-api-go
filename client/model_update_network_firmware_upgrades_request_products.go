...
type UpdateNetworkFirmwareUpgradesRequestProducts struct {
	...
	WirelessController *UpdateNetworkFirmwareUpgradesRequestProductsWireless `json:"wirelessController,omitempty"`
	SecureConnect *UpdateNetworkFirmwareUpgradesRequestProductsWireless `json:"secureConnect,omitempty"`
...
// SetWirelessController gets a reference to the given UpdateNetworkFirmwareUpgradesRequestProductsWireless and assigns it to the WirelessController field.
...
// SetSecureConnect gets a reference to the given UpdateNetworkFirmwareUpgradesRequestProductsWireless and assigns it to the SecureConnect field.
