...
type CreateOrganizationAlertsProfileRequest struct {
	...
	Recipients GetOrganizationAlertsProfiles200ResponseInnerRecipients `json:"recipients"`
...
type _CreateOrganizationAlertsProfileRequest CreateOrganizationAlertsProfileRequest
...
func (o *CreateOrganizationAlertsProfileRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationAlertsProfileRequest := _CreateOrganizationAlertsProfileRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationAlertsProfileRequest)

	if err != nil {
		return err
	}

	*o = CreateOrganizationAlertsProfileRequest(varCreateOrganizationAlertsProfileRequest)
