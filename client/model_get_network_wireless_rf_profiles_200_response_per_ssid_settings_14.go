...
// checks if the GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14{}

// GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 Settings for SSID 14
type GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 struct {
	// Name of SSID
...
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14{}
	return &this
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) GetBands() GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) GetBandsOk() (*GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) SetBands(v GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands) {
	o.Bands = &v
}
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 struct {
	value *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) Get() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) Set(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14 {
	return &NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings14) UnmarshalJSON(src []byte) error {
	v.isSet = true
