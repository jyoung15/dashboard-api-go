...
type _GetOrganizationActionBatches200ResponseInner GetOrganizationActionBatches200ResponseInner
...
func (o *GetOrganizationActionBatches200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetOrganizationActionBatches200ResponseInner := _GetOrganizationActionBatches200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetOrganizationActionBatches200ResponseInner)

	if err != nil {
		return err
	}

	*o = GetOrganizationActionBatches200ResponseInner(varGetOrganizationActionBatches200ResponseInner)
