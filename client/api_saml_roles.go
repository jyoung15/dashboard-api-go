...
func (r SamlRolesAPICreateOrganizationSamlRoleRequest) Execute() (*GetOrganizationSamlRoles200ResponseInner, *http.Response, error) {
...
func (a *SamlRolesAPIService) CreateOrganizationSamlRoleExecute(r SamlRolesAPICreateOrganizationSamlRoleRequest) (*GetOrganizationSamlRoles200ResponseInner, *http.Response, error) {
	var (
