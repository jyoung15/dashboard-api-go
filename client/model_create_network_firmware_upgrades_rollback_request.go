...
type _CreateNetworkFirmwareUpgradesRollbackRequest CreateNetworkFirmwareUpgradesRollbackRequest
...
func (o *CreateNetworkFirmwareUpgradesRollbackRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkFirmwareUpgradesRollbackRequest := _CreateNetworkFirmwareUpgradesRollbackRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkFirmwareUpgradesRollbackRequest)

	if err != nil {
		return err
	}

	*o = CreateNetworkFirmwareUpgradesRollbackRequest(varCreateNetworkFirmwareUpgradesRollbackRequest)
