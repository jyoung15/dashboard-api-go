...
// checks if the GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic{}

// GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic The time bucket's voice traffic latency history
type GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic struct {
...
func NewGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic() *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic {
	this := GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic{}
	return &this
}
...
func (o GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic struct {
	value *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic
	isSet bool
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) Get() *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic {
	return v.value
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) Set(val *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic(val *GetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic {
	return &NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessClientLatencyHistory200ResponseInnerLatencyBinsByCategoryVoiceTraffic) UnmarshalJSON(src []byte) error {
	v.isSet = true
