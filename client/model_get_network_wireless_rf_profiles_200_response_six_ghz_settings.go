...
// checks if the GetNetworkWirelessRfProfiles200ResponseSixGhzSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessRfProfiles200ResponseSixGhzSettings{}

// GetNetworkWirelessRfProfiles200ResponseSixGhzSettings Settings related to 6Ghz band. Only applicable to networks with 6Ghz capable APs
type GetNetworkWirelessRfProfiles200ResponseSixGhzSettings struct {
...
func NewGetNetworkWirelessRfProfiles200ResponseSixGhzSettings() *GetNetworkWirelessRfProfiles200ResponseSixGhzSettings {
	this := GetNetworkWirelessRfProfiles200ResponseSixGhzSettings{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *GetNetworkWirelessRfProfiles200ResponseSixGhzSettings) GetMinBitrateOk() (*int32, bool) {
	if o == nil || IsNil(o.MinBitrate) {
		return nil, false
	}
...
func (o GetNetworkWirelessRfProfiles200ResponseSixGhzSettings) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessRfProfiles200ResponseSixGhzSettings) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings struct {
	value *GetNetworkWirelessRfProfiles200ResponseSixGhzSettings
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings) Get() *GetNetworkWirelessRfProfiles200ResponseSixGhzSettings {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings) Set(val *GetNetworkWirelessRfProfiles200ResponseSixGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings(val *GetNetworkWirelessRfProfiles200ResponseSixGhzSettings) *NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings {
	return &NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponseSixGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
