...
func (r RecentAPIGetDeviceCameraAnalyticsRecentRequest) Execute() ([]GetDeviceCameraAnalyticsRecent200ResponseInner, *http.Response, error) {
...
// Deprecated
func (a *RecentAPIService) GetDeviceCameraAnalyticsRecentExecute(r RecentAPIGetDeviceCameraAnalyticsRecentRequest) ([]GetDeviceCameraAnalyticsRecent200ResponseInner, *http.Response, error) {
	var (
