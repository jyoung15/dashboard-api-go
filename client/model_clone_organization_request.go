...
type _CloneOrganizationRequest CloneOrganizationRequest
...
func (o *CloneOrganizationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCloneOrganizationRequest := _CloneOrganizationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCloneOrganizationRequest)

	if err != nil {
		return err
	}

	*o = CloneOrganizationRequest(varCloneOrganizationRequest)
