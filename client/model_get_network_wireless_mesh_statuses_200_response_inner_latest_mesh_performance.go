...
// GetNetworkWirelessMeshStatuses200ResponseInnerLatestMeshPerformance struct for GetNetworkWirelessMeshStatuses200ResponseInnerLatestMeshPerformance
...
func (o *GetNetworkWirelessMeshStatuses200ResponseInnerLatestMeshPerformance) GetMbps() string {
...
func (o *GetNetworkWirelessMeshStatuses200ResponseInnerLatestMeshPerformance) GetMbpsOk() (*string, bool) {
	if o == nil || IsNil(o.Mbps) {
		return nil, false
	}
	return o.Mbps, true
...
// SetMbps gets a reference to the given string and assigns it to the Mbps field.
func (o *GetNetworkWirelessMeshStatuses200ResponseInnerLatestMeshPerformance) SetMbps(v string) {
	o.Mbps = &v
}
