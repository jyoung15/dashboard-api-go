...
func (r RelationshipsAPIGetDeviceSensorRelationshipsRequest) Execute() (*GetDeviceSensorRelationships200Response, *http.Response, error) {
...
func (a *RelationshipsAPIService) GetDeviceSensorRelationshipsExecute(r RelationshipsAPIGetDeviceSensorRelationshipsRequest) (*GetDeviceSensorRelationships200Response, *http.Response, error) {
	var (
...
func (r RelationshipsAPIUpdateDeviceSensorRelationshipsRequest) Execute() (*GetDeviceSensorRelationships200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetDeviceSensorRelationships200Response
func (a *RelationshipsAPIService) UpdateDeviceSensorRelationshipsExecute(r RelationshipsAPIUpdateDeviceSensorRelationshipsRequest) (*GetDeviceSensorRelationships200Response, *http.Response, error) {
	var (
