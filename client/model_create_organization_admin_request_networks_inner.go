...
type _CreateOrganizationAdminRequestNetworksInner CreateOrganizationAdminRequestNetworksInner
...
func (o *CreateOrganizationAdminRequestNetworksInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationAdminRequestNetworksInner := _CreateOrganizationAdminRequestNetworksInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationAdminRequestNetworksInner)

	if err != nil {
		return err
	}

	*o = CreateOrganizationAdminRequestNetworksInner(varCreateOrganizationAdminRequestNetworksInner)
