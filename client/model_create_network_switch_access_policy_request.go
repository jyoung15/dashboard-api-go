...
// checks if the CreateNetworkSwitchAccessPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkSwitchAccessPolicyRequest{}
...
type _CreateNetworkSwitchAccessPolicyRequest CreateNetworkSwitchAccessPolicyRequest
...
func (o CreateNetworkSwitchAccessPolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateNetworkSwitchAccessPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkSwitchAccessPolicyRequest := _CreateNetworkSwitchAccessPolicyRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkSwitchAccessPolicyRequest)

	if err != nil {
		return err
	}

	*o = CreateNetworkSwitchAccessPolicyRequest(varCreateNetworkSwitchAccessPolicyRequest)
