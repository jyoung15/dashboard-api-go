...
type GetNetworkSwitchAccessPolicies200ResponseInner struct {
	...
	Counts *GetNetworkSwitchAccessPolicies200ResponseInnerCounts `json:"counts,omitempty"`
}
...
func (o *GetNetworkSwitchAccessPolicies200ResponseInner) GetCounts() GetNetworkSwitchAccessPolicies200ResponseInnerCounts {
	if o == nil || IsNil(o.Counts) {
		var ret GetNetworkSwitchAccessPolicies200ResponseInnerCounts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given GetNetworkSwitchAccessPolicies200ResponseInnerCounts and assigns it to the Counts field.
