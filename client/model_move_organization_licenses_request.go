...
type _MoveOrganizationLicensesRequest MoveOrganizationLicensesRequest
...
func (o *MoveOrganizationLicensesRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varMoveOrganizationLicensesRequest := _MoveOrganizationLicensesRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMoveOrganizationLicensesRequest)

	if err != nil {
		return err
	}

	*o = MoveOrganizationLicensesRequest(varMoveOrganizationLicensesRequest)
