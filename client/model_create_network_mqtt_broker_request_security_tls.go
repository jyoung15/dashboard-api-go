...
// checks if the CreateNetworkMqttBrokerRequestSecurityTls type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkMqttBrokerRequestSecurityTls{}

// CreateNetworkMqttBrokerRequestSecurityTls TLS settings of the MQTT broker.
type CreateNetworkMqttBrokerRequestSecurityTls struct {
...
func NewCreateNetworkMqttBrokerRequestSecurityTls() *CreateNetworkMqttBrokerRequestSecurityTls {
	this := CreateNetworkMqttBrokerRequestSecurityTls{}
	return &this
}
...
func (o CreateNetworkMqttBrokerRequestSecurityTls) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkMqttBrokerRequestSecurityTls) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkMqttBrokerRequestSecurityTls struct {
	value *CreateNetworkMqttBrokerRequestSecurityTls
	isSet bool
}

func (v NullableCreateNetworkMqttBrokerRequestSecurityTls) Get() *CreateNetworkMqttBrokerRequestSecurityTls {
	return v.value
}

func (v *NullableCreateNetworkMqttBrokerRequestSecurityTls) Set(val *CreateNetworkMqttBrokerRequestSecurityTls) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkMqttBrokerRequestSecurityTls) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkMqttBrokerRequestSecurityTls) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkMqttBrokerRequestSecurityTls(val *CreateNetworkMqttBrokerRequestSecurityTls) *NullableCreateNetworkMqttBrokerRequestSecurityTls {
	return &NullableCreateNetworkMqttBrokerRequestSecurityTls{value: val, isSet: true}
}

func (v NullableCreateNetworkMqttBrokerRequestSecurityTls) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkMqttBrokerRequestSecurityTls) UnmarshalJSON(src []byte) error {
	v.isSet = true
