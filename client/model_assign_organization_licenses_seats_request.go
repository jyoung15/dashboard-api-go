...
type _AssignOrganizationLicensesSeatsRequest AssignOrganizationLicensesSeatsRequest
...
func (o *AssignOrganizationLicensesSeatsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAssignOrganizationLicensesSeatsRequest := _AssignOrganizationLicensesSeatsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAssignOrganizationLicensesSeatsRequest)

	if err != nil {
		return err
	}

	*o = AssignOrganizationLicensesSeatsRequest(varAssignOrganizationLicensesSeatsRequest)
