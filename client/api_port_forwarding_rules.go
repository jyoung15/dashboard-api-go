...
func (r PortForwardingRulesAPIGetDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*GetDeviceCellularGatewayPortForwardingRules200Response, *http.Response, error) {
...
func (a *PortForwardingRulesAPIService) GetDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesAPIGetDeviceCellularGatewayPortForwardingRulesRequest) (*GetDeviceCellularGatewayPortForwardingRules200Response, *http.Response, error) {
	var (
...
func (r PortForwardingRulesAPIGetNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*GetNetworkApplianceFirewallPortForwardingRules200Response, *http.Response, error) {
...
func (a *PortForwardingRulesAPIService) GetNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesAPIGetNetworkApplianceFirewallPortForwardingRulesRequest) (*GetNetworkApplianceFirewallPortForwardingRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r PortForwardingRulesAPIUpdateDeviceCellularGatewayPortForwardingRulesRequest) Execute() (*GetDeviceCellularGatewayPortForwardingRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetDeviceCellularGatewayPortForwardingRules200Response
func (a *PortForwardingRulesAPIService) UpdateDeviceCellularGatewayPortForwardingRulesExecute(r PortForwardingRulesAPIUpdateDeviceCellularGatewayPortForwardingRulesRequest) (*GetDeviceCellularGatewayPortForwardingRules200Response, *http.Response, error) {
	var (
...
func (r PortForwardingRulesAPIUpdateNetworkApplianceFirewallPortForwardingRulesRequest) Execute() (*GetNetworkApplianceFirewallPortForwardingRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkApplianceFirewallPortForwardingRules200Response
func (a *PortForwardingRulesAPIService) UpdateNetworkApplianceFirewallPortForwardingRulesExecute(r PortForwardingRulesAPIUpdateNetworkApplianceFirewallPortForwardingRulesRequest) (*GetNetworkApplianceFirewallPortForwardingRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
