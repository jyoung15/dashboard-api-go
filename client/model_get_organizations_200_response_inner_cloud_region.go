...
type GetOrganizations200ResponseInnerCloudRegion struct {
	...
	Host *GetOrganizations200ResponseInnerCloudRegionHost `json:"host,omitempty"`
}
...
func (o *GetOrganizations200ResponseInnerCloudRegion) GetHost() GetOrganizations200ResponseInnerCloudRegionHost {
	if o == nil || IsNil(o.Host) {
		var ret GetOrganizations200ResponseInnerCloudRegionHost
		return ret
	}
	return *o.Host
}
...
// SetHost gets a reference to the given GetOrganizations200ResponseInnerCloudRegionHost and assigns it to the Host field.
