...
// checks if the GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner{}

// GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner struct for GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner
type GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner struct {
...
func NewGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner() *GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner {
	this := GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner{}
	return &this
}
...
func (o GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner struct {
	value *GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner
	isSet bool
}

func (v NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) Get() *GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner {
	return v.value
}

func (v *NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) Set(val *GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner(val *GetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) *NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner {
	return &NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner{value: val, isSet: true}
}

func (v NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkApplianceFirewallInboundCellularFirewallRules200ResponseRulesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
