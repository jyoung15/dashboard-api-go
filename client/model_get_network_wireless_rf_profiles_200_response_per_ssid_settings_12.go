...
// checks if the GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12{}

// GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 Settings for SSID 12
type GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 struct {
	// Name of SSID
...
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12{}
	return &this
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) SetBandOperationMode(v string) {
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 struct {
	value *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) Get() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) Set(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12 {
	return &NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings12) UnmarshalJSON(src []byte) error {
	v.isSet = true
