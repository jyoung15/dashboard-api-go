...
type UpdateOrganizationRequest struct {
	...
	Management *CreateOrganizationRequestManagement `json:"management,omitempty"`
...
func (o *UpdateOrganizationRequest) GetManagement() CreateOrganizationRequestManagement {
	if o == nil || IsNil(o.Management) {
		var ret CreateOrganizationRequestManagement
		return ret
	}
	return *o.Management
}
...
// SetManagement gets a reference to the given CreateOrganizationRequestManagement and assigns it to the Management field.
