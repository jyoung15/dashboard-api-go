...
// NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 instantiates a new GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9{}
	return &this
}

// NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9WithDefaults instantiates a new GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9WithDefaults() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9{}
	return &this
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) SetName(v string) {
	o.Name = &v
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) SetMinBitrate(v int32) {
	o.MinBitrate = &v
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) SetBandOperationMode(v string) {
	o.BandOperationMode = &v
}

// GetBands returns the Bands field value if set, zero value otherwise.
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) GetBands() GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) GetBandsOk() (*GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) SetBands(v GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands) {
	o.Bands = &v
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) SetBandSteeringEnabled(v bool) {
...
type NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 struct {
	value *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) Get() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) Set(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9 {
	return &NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings9) UnmarshalJSON(src []byte) error {
	v.isSet = true
