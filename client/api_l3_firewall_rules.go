...
func (r L3FirewallRulesAPIGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
...
func (a *L3FirewallRulesAPIService) GetNetworkWirelessSsidFirewallL3FirewallRulesExecute(r L3FirewallRulesAPIGetNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r L3FirewallRulesAPIUpdateNetworkApplianceFirewallL3FirewallRulesRequest) UpdateNetworkApplianceFirewallL3FirewallRulesRequest(updateNetworkApplianceFirewallL3FirewallRulesRequest UpdateNetworkApplianceFirewallL3FirewallRulesRequest) L3FirewallRulesAPIUpdateNetworkApplianceFirewallL3FirewallRulesRequest {
...
func (r L3FirewallRulesAPIUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest(updateNetworkWirelessSsidFirewallL3FirewallRulesRequest UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) L3FirewallRulesAPIUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest {
	r.updateNetworkWirelessSsidFirewallL3FirewallRulesRequest = &updateNetworkWirelessSsidFirewallL3FirewallRulesRequest
	return r
}

func (r L3FirewallRulesAPIUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) Execute() (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkWirelessSsidFirewallL3FirewallRules200Response
func (a *L3FirewallRulesAPIService) UpdateNetworkWirelessSsidFirewallL3FirewallRulesExecute(r L3FirewallRulesAPIUpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest) (*GetNetworkWirelessSsidFirewallL3FirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
