...
// checks if the GetDeviceManagementInterface200ResponseWan2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDeviceManagementInterface200ResponseWan2{}

// GetDeviceManagementInterface200ResponseWan2 WAN 2 settings (only for MX devices)
type GetDeviceManagementInterface200ResponseWan2 struct {
...
func NewGetDeviceManagementInterface200ResponseWan2() *GetDeviceManagementInterface200ResponseWan2 {
	this := GetDeviceManagementInterface200ResponseWan2{}
	return &this
}
...
func (o GetDeviceManagementInterface200ResponseWan2) MarshalJSON() ([]byte, error) {
...
func (o GetDeviceManagementInterface200ResponseWan2) ToMap() (map[string]interface{}, error) {
...
type NullableGetDeviceManagementInterface200ResponseWan2 struct {
	value *GetDeviceManagementInterface200ResponseWan2
	isSet bool
}

func (v NullableGetDeviceManagementInterface200ResponseWan2) Get() *GetDeviceManagementInterface200ResponseWan2 {
	return v.value
}

func (v *NullableGetDeviceManagementInterface200ResponseWan2) Set(val *GetDeviceManagementInterface200ResponseWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDeviceManagementInterface200ResponseWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDeviceManagementInterface200ResponseWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDeviceManagementInterface200ResponseWan2(val *GetDeviceManagementInterface200ResponseWan2) *NullableGetDeviceManagementInterface200ResponseWan2 {
	return &NullableGetDeviceManagementInterface200ResponseWan2{value: val, isSet: true}
}

func (v NullableGetDeviceManagementInterface200ResponseWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDeviceManagementInterface200ResponseWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
