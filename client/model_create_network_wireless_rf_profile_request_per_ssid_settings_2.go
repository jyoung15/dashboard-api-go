...
// checks if the CreateNetworkWirelessRfProfileRequestPerSsidSettings2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkWirelessRfProfileRequestPerSsidSettings2{}

// CreateNetworkWirelessRfProfileRequestPerSsidSettings2 Settings for SSID 2
type CreateNetworkWirelessRfProfileRequestPerSsidSettings2 struct {
...
func NewCreateNetworkWirelessRfProfileRequestPerSsidSettings2() *CreateNetworkWirelessRfProfileRequestPerSsidSettings2 {
	this := CreateNetworkWirelessRfProfileRequestPerSsidSettings2{}
	return &this
}
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings2) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings2) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2 struct {
	value *CreateNetworkWirelessRfProfileRequestPerSsidSettings2
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2) Get() *CreateNetworkWirelessRfProfileRequestPerSsidSettings2 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2) Set(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings2) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings2) *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2 {
	return &NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings2) UnmarshalJSON(src []byte) error {
	v.isSet = true
