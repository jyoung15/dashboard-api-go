...
// checks if the GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4{}

// GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 Settings for SSID 4
type GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 struct {
	// Name of SSID
...
func NewGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 {
	this := GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4{}
	return &this
}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) GetBands() GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) GetBandsOk() (*GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) SetBands(v GetNetworkWirelessRfProfiles200ResponseApBandSettingsBands) {
	o.Bands = &v
}
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) MarshalJSON() ([]byte, error) {
...
func (o GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) ToMap() (map[string]interface{}, error) {
...
type NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 struct {
	value *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4
	isSet bool
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) Get() *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 {
	return v.value
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) Set(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4(val *GetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4 {
	return &NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4{value: val, isSet: true}
}

func (v NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNetworkWirelessRfProfiles200ResponsePerSsidSettings4) UnmarshalJSON(src []byte) error {
	v.isSet = true
