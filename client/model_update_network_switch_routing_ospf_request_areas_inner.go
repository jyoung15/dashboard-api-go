...
type _UpdateNetworkSwitchRoutingOspfRequestAreasInner UpdateNetworkSwitchRoutingOspfRequestAreasInner
...
func (o *UpdateNetworkSwitchRoutingOspfRequestAreasInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkSwitchRoutingOspfRequestAreasInner := _UpdateNetworkSwitchRoutingOspfRequestAreasInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkSwitchRoutingOspfRequestAreasInner)

	if err != nil {
		return err
	}

	*o = UpdateNetworkSwitchRoutingOspfRequestAreasInner(varUpdateNetworkSwitchRoutingOspfRequestAreasInner)
