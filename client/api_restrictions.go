...
func (r RestrictionsAPIGetNetworkSmDeviceRestrictionsRequest) Execute() (*GetNetworkSmDeviceRestrictions200Response, *http.Response, error) {
...
func (a *RestrictionsAPIService) GetNetworkSmDeviceRestrictionsExecute(r RestrictionsAPIGetNetworkSmDeviceRestrictionsRequest) (*GetNetworkSmDeviceRestrictions200Response, *http.Response, error) {
	var (
