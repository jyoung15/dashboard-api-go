...
// checks if the CreateNetworkApplianceRfProfileRequestPerSsidSettings3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkApplianceRfProfileRequestPerSsidSettings3{}

// CreateNetworkApplianceRfProfileRequestPerSsidSettings3 Settings for SSID 3
type CreateNetworkApplianceRfProfileRequestPerSsidSettings3 struct {
...
func NewCreateNetworkApplianceRfProfileRequestPerSsidSettings3() *CreateNetworkApplianceRfProfileRequestPerSsidSettings3 {
	this := CreateNetworkApplianceRfProfileRequestPerSsidSettings3{}
	return &this
}
...
func (o CreateNetworkApplianceRfProfileRequestPerSsidSettings3) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkApplianceRfProfileRequestPerSsidSettings3) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3 struct {
	value *CreateNetworkApplianceRfProfileRequestPerSsidSettings3
	isSet bool
}

func (v NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3) Get() *CreateNetworkApplianceRfProfileRequestPerSsidSettings3 {
	return v.value
}

func (v *NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3) Set(val *CreateNetworkApplianceRfProfileRequestPerSsidSettings3) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3(val *CreateNetworkApplianceRfProfileRequestPerSsidSettings3) *NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3 {
	return &NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3{value: val, isSet: true}
}

func (v NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkApplianceRfProfileRequestPerSsidSettings3) UnmarshalJSON(src []byte) error {
	v.isSet = true
