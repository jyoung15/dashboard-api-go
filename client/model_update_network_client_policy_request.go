...
type _UpdateNetworkClientPolicyRequest UpdateNetworkClientPolicyRequest
...
func (o *UpdateNetworkClientPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkClientPolicyRequest := _UpdateNetworkClientPolicyRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkClientPolicyRequest)

	if err != nil {
		return err
	}

	*o = UpdateNetworkClientPolicyRequest(varUpdateNetworkClientPolicyRequest)
