...
type _UpdateNetworkSwitchStpRequestStpBridgePriorityInner UpdateNetworkSwitchStpRequestStpBridgePriorityInner
...
func (o *UpdateNetworkSwitchStpRequestStpBridgePriorityInner) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkSwitchStpRequestStpBridgePriorityInner := _UpdateNetworkSwitchStpRequestStpBridgePriorityInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkSwitchStpRequestStpBridgePriorityInner)

	if err != nil {
		return err
	}

	*o = UpdateNetworkSwitchStpRequestStpBridgePriorityInner(varUpdateNetworkSwitchStpRequestStpBridgePriorityInner)
