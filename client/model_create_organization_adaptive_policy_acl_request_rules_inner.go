...
type _CreateOrganizationAdaptivePolicyAclRequestRulesInner CreateOrganizationAdaptivePolicyAclRequestRulesInner
...
func (o *CreateOrganizationAdaptivePolicyAclRequestRulesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateOrganizationAdaptivePolicyAclRequestRulesInner := _CreateOrganizationAdaptivePolicyAclRequestRulesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateOrganizationAdaptivePolicyAclRequestRulesInner)

	if err != nil {
		return err
	}

	*o = CreateOrganizationAdaptivePolicyAclRequestRulesInner(varCreateOrganizationAdaptivePolicyAclRequestRulesInner)
