...
func (r SimsAPIGetDeviceCellularSimsRequest) Execute() (*GetDeviceCellularSims200Response, *http.Response, error) {
...
func (a *SimsAPIService) GetDeviceCellularSimsExecute(r SimsAPIGetDeviceCellularSimsRequest) (*GetDeviceCellularSims200Response, *http.Response, error) {
	var (
...
func (r SimsAPIUpdateDeviceCellularSimsRequest) Execute() (*GetDeviceCellularSims200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetDeviceCellularSims200Response
func (a *SimsAPIService) UpdateDeviceCellularSimsExecute(r SimsAPIUpdateDeviceCellularSimsRequest) (*GetDeviceCellularSims200Response, *http.Response, error) {
	var (
