...
type _CreateNetworkWebhooksHttpServerRequest CreateNetworkWebhooksHttpServerRequest
...
func (o *CreateNetworkWebhooksHttpServerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkWebhooksHttpServerRequest := _CreateNetworkWebhooksHttpServerRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkWebhooksHttpServerRequest)

	if err != nil {
		return err
	}

	*o = CreateNetworkWebhooksHttpServerRequest(varCreateNetworkWebhooksHttpServerRequest)
