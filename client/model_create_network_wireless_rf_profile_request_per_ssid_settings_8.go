...
// checks if the CreateNetworkWirelessRfProfileRequestPerSsidSettings8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkWirelessRfProfileRequestPerSsidSettings8{}

// CreateNetworkWirelessRfProfileRequestPerSsidSettings8 Settings for SSID 8
type CreateNetworkWirelessRfProfileRequestPerSsidSettings8 struct {
...
func NewCreateNetworkWirelessRfProfileRequestPerSsidSettings8() *CreateNetworkWirelessRfProfileRequestPerSsidSettings8 {
	this := CreateNetworkWirelessRfProfileRequestPerSsidSettings8{}
	return &this
}
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings8) GetBands() CreateNetworkWirelessRfProfileRequestApBandSettingsBands {
...
// and a boolean to check if the value has been set.
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings8) GetBandsOk() (*CreateNetworkWirelessRfProfileRequestApBandSettingsBands, bool) {
	if o == nil || IsNil(o.Bands) {
		return nil, false
	}
	return o.Bands, true
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings8) HasBands() bool {
	if o != nil && !IsNil(o.Bands) {
		return true
	}
...
func (o *CreateNetworkWirelessRfProfileRequestPerSsidSettings8) SetBands(v CreateNetworkWirelessRfProfileRequestApBandSettingsBands) {
	o.Bands = &v
}
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings8) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkWirelessRfProfileRequestPerSsidSettings8) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8 struct {
	value *CreateNetworkWirelessRfProfileRequestPerSsidSettings8
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8) Get() *CreateNetworkWirelessRfProfileRequestPerSsidSettings8 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8) Set(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings8) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8(val *CreateNetworkWirelessRfProfileRequestPerSsidSettings8) *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8 {
	return &NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfileRequestPerSsidSettings8) UnmarshalJSON(src []byte) error {
	v.isSet = true
