...
func (r StormControlAPIUpdateNetworkSwitchStormControlRequest) Execute() (*GetNetworkSwitchStormControl200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetNetworkSwitchStormControl200Response
func (a *StormControlAPIService) UpdateNetworkSwitchStormControlExecute(r StormControlAPIUpdateNetworkSwitchStormControlRequest) (*GetNetworkSwitchStormControl200Response, *http.Response, error) {
	var (
