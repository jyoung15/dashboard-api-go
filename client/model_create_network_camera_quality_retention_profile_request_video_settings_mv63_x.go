...
type _CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X
...
func (o *CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X := _CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X)

	if err != nil {
		return err
	}

	*o = CreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X(varCreateNetworkCameraQualityRetentionProfileRequestVideoSettingsMV63X)
