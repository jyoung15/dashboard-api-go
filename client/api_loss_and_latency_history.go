...
func (r LossAndLatencyHistoryAPIGetDeviceLossAndLatencyHistoryRequest) Execute() ([]GetDeviceLossAndLatencyHistory200ResponseInner, *http.Response, error) {
...
func (a *LossAndLatencyHistoryAPIService) GetDeviceLossAndLatencyHistoryExecute(r LossAndLatencyHistoryAPIGetDeviceLossAndLatencyHistoryRequest) ([]GetDeviceLossAndLatencyHistory200ResponseInner, *http.Response, error) {
	var (
