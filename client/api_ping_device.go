...
func (r PingDeviceAPIGetDeviceLiveToolsPingDeviceRequest) Execute() (*GetDeviceLiveToolsPingDevice200Response, *http.Response, error) {
...
func (a *PingDeviceAPIService) GetDeviceLiveToolsPingDeviceExecute(r PingDeviceAPIGetDeviceLiveToolsPingDeviceRequest) (*GetDeviceLiveToolsPingDevice200Response, *http.Response, error) {
	var (
