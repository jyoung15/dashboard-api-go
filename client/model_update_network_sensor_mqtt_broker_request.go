...
type _UpdateNetworkSensorMqttBrokerRequest UpdateNetworkSensorMqttBrokerRequest
...
func (o *UpdateNetworkSensorMqttBrokerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkSensorMqttBrokerRequest := _UpdateNetworkSensorMqttBrokerRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkSensorMqttBrokerRequest)

	if err != nil {
		return err
	}

	*o = UpdateNetworkSensorMqttBrokerRequest(varUpdateNetworkSensorMqttBrokerRequest)
