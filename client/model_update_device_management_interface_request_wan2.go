...
// checks if the UpdateDeviceManagementInterfaceRequestWan2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDeviceManagementInterfaceRequestWan2{}
...
func (o UpdateDeviceManagementInterfaceRequestWan2) ToMap() (map[string]interface{}, error) {
