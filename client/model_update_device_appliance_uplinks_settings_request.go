...
type _UpdateDeviceApplianceUplinksSettingsRequest UpdateDeviceApplianceUplinksSettingsRequest
...
func (o *UpdateDeviceApplianceUplinksSettingsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDeviceApplianceUplinksSettingsRequest := _UpdateDeviceApplianceUplinksSettingsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDeviceApplianceUplinksSettingsRequest)

	if err != nil {
		return err
	}

	*o = UpdateDeviceApplianceUplinksSettingsRequest(varUpdateDeviceApplianceUplinksSettingsRequest)
