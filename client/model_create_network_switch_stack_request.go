...
type _CreateNetworkSwitchStackRequest CreateNetworkSwitchStackRequest
...
func (o *CreateNetworkSwitchStackRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkSwitchStackRequest := _CreateNetworkSwitchStackRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkSwitchStackRequest)

	if err != nil {
		return err
	}

	*o = CreateNetworkSwitchStackRequest(varCreateNetworkSwitchStackRequest)
