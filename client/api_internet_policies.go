...
func (r InternetPoliciesAPIUpdateNetworkApplianceSdwanInternetPoliciesRequest) UpdateNetworkApplianceSdwanInternetPoliciesRequest(updateNetworkApplianceSdwanInternetPoliciesRequest UpdateNetworkApplianceSdwanInternetPoliciesRequest) InternetPoliciesAPIUpdateNetworkApplianceSdwanInternetPoliciesRequest {
	r.updateNetworkApplianceSdwanInternetPoliciesRequest = &updateNetworkApplianceSdwanInternetPoliciesRequest
	return r
}

func (r InternetPoliciesAPIUpdateNetworkApplianceSdwanInternetPoliciesRequest) Execute() (*UpdateNetworkApplianceSdwanInternetPolicies200Response, *http.Response, error) {
...
func (a *InternetPoliciesAPIService) UpdateNetworkApplianceSdwanInternetPoliciesExecute(r InternetPoliciesAPIUpdateNetworkApplianceSdwanInternetPoliciesRequest) (*UpdateNetworkApplianceSdwanInternetPolicies200Response, *http.Response, error) {
	var (
