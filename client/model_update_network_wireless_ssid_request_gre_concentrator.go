...
type _UpdateNetworkWirelessSsidRequestGreConcentrator UpdateNetworkWirelessSsidRequestGreConcentrator
...
func (o *UpdateNetworkWirelessSsidRequestGreConcentrator) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateNetworkWirelessSsidRequestGreConcentrator := _UpdateNetworkWirelessSsidRequestGreConcentrator{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateNetworkWirelessSsidRequestGreConcentrator)

	if err != nil {
		return err
	}

	*o = UpdateNetworkWirelessSsidRequestGreConcentrator(varUpdateNetworkWirelessSsidRequestGreConcentrator)
