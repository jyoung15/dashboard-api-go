...
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) NetworkTag(networkTag string) ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest {
	r.networkTag = &networkTag
	return r
}

// Match result to an exact device tag
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) DeviceTag(deviceTag string) ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest {
	r.deviceTag = &deviceTag
	return r
}

// Match result to an exact network id
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) NetworkId(networkId string) ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest {
	r.networkId = &networkId
	return r
}

// Set number of desired results to return. Default is 10.
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) Quantity(quantity int32) ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest {
	r.quantity = &quantity
	return r
}

// Filter results by ssid name
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) SsidName(ssidName string) ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest {
	r.ssidName = &ssidName
	return r
}

// Filter results by usage uplink
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) UsageUplink(usageUplink string) ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest {
...
func (r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) Execute() ([]GetOrganizationSummaryTopAppliancesByUtilization200ResponseInner, *http.Response, error) {
...
func (a *ByUtilizationAPIService) GetOrganizationSummaryTopAppliancesByUtilizationExecute(r ByUtilizationAPIGetOrganizationSummaryTopAppliancesByUtilizationRequest) ([]GetOrganizationSummaryTopAppliancesByUtilization200ResponseInner, *http.Response, error) {
	var (
