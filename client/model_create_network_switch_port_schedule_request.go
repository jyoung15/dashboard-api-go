...
type _CreateNetworkSwitchPortScheduleRequest CreateNetworkSwitchPortScheduleRequest
...
func (o *CreateNetworkSwitchPortScheduleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateNetworkSwitchPortScheduleRequest := _CreateNetworkSwitchPortScheduleRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateNetworkSwitchPortScheduleRequest)

	if err != nil {
		return err
	}

	*o = CreateNetworkSwitchPortScheduleRequest(varCreateNetworkSwitchPortScheduleRequest)
