...
type GetOrganizationSamlRoles200ResponseInner struct {
	...
	Camera []GetOrganizationSamlRoles200ResponseInnerCameraInner `json:"camera,omitempty"`
}
...
func (o *GetOrganizationSamlRoles200ResponseInner) GetCamera() []GetOrganizationSamlRoles200ResponseInnerCameraInner {
	if o == nil || IsNil(o.Camera) {
		var ret []GetOrganizationSamlRoles200ResponseInnerCameraInner
		return ret
	}
	return o.Camera
}
...
// SetCamera gets a reference to the given []GetOrganizationSamlRoles200ResponseInnerCameraInner and assigns it to the Camera field.
