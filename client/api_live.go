...
func (r LiveAPIGetDeviceCameraAnalyticsLiveRequest) Execute() (*GetDeviceCameraAnalyticsLive200Response, *http.Response, error) {
...
// Deprecated
func (a *LiveAPIService) GetDeviceCameraAnalyticsLiveExecute(r LiveAPIGetDeviceCameraAnalyticsLiveRequest) (*GetDeviceCameraAnalyticsLive200Response, *http.Response, error) {
	var (
